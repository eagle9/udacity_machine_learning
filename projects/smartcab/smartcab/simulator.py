...
class Simulator(object):
	...
	def __init__(self, env, size=None, update_delay=2.0, display=True, log_metrics=False, optimized=False, detail_out=False):
		self.env = env
	...
	def run(self, tolerance=0.05, n_test=0):
		...
		print "\nSimulation ended. . . "
		print test_success*1.0/(test_success+test_fail), test_success,test_fail, 
